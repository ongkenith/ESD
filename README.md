...
Answer: If you are grading this after 2nd May (or 100 emails per API key), the free trial API for the email has expired. Please follow the following steps to get an API key and add it to .env file <br>
