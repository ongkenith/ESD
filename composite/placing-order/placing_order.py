...
CUSTOMER_SERVICE_URL = environ.get('CUSTOMER_SERVICE_URL', 'http://localhost:5001') + '/customer'
ITEM_SERVICE_URL = environ.get('ITEM_SERVICE_URL', 'http://localhost:5002') + '/items'
ORDER_SERVICE_URL = environ.get('ORDER_SERVICE_URL', 'http://localhost:5004') + '/order'
